  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (Array.isArray(detail)) {
        // Pydantic error list -> on prend les messages
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-950">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute inset-y-0 left-0 pl-4 pr-2 flex items-center text-zinc-500 hover:text-emerald-400 transition"
              >
                <svg
                  className="w-5 h-5"
                  viewBox="0 0 24 24"
      ...
      "
          ...
          {/* POIDS + TAILLE (ligne 2, chacun 50%) */}
